...
export const GITHUB_USERNAME = "MostafaSensei106";

export const knowledgeEducationItems = [
  {
    tag: "Flutter Developer [Volunteer]",
    subTag: "Lothgha",
    subTagHyperlink: "https://lothgha.com/",
  ...
  },
  {
    ...
    desc: "Studying Computer's Science, building skills in programming, algorithms, and AI.",
  ...
  },
  {
    ...
    desc: "Japanese is my third language, learning with goal of working in Japan.",
    isRight: true,
    startDate: "2019-01-01",
    showDate: false,
  },
